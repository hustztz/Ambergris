...
RCCode AgRealityComputingManager::loadProject(std::wstring fileName, bool autoSetGeoRef /*= false*/)
{
...
bool AgRealityComputingManager::unLoadProject()
{
	mVisibleNodes.clear();
...
void AgRealityComputingManager::_UpdateBounds()
{
	m_pointCloudProject.updateProjectBounds();
...
void AgRealityComputingManager::_SetPointRequestsForVisibleNodes()
{
...
void AgRealityComputingManager::_UpdateVisibleNodes(AgCameraView::Handle view)
{
...
bool AgRealityComputingManager::hasGeoReference()
{
	return abs(Singleton<AgSceneDatabase>::instance().mWorldCoordInfo.getGeoReference().length()) > Math::Constants::epsilon;
}

void AgRealityComputingManager::setGeoReference(const RCVector3d& offset)
{
...
void AgRealityComputingManager::autoSetGeoReference()
{
	_UpdateBounds();
